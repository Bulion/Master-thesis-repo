...
\begin{figure}[!ht]
  ...
  \caption{Reality-Virtuality (RV) Contunuum}
  \label{fig:RVContinuum}
\end{figure}

On the most left side of this line there is our real environment with real objects in no way disturbed by computer graphics. On the other hand on the most right side there is fully 3D generated world with could even in example not holding known by us laws of physics. Between two of those is everything with is mixing one part with another. Depending on what balance is, then we will talk about Augmented Reality or Augmented Virtuality. When there is more real object than virtual ones then it is AR.
