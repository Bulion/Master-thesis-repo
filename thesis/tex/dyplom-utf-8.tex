...
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{MoCapStudio}
  \caption{Motion capture studio}
  \label{fig:MoCapStudio}
\end{subfigure}%
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{depthData}
  \caption{3D Camera Depth Data}
  \label{fig:depthData}
\end{subfigure}
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{DWM1000}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.8\textwidth]{SLAMHololens}
